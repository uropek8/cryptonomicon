const API_KEY = "007e40a1d992ab907d6960e0627091251a00b7b0a56b288c075ba9e53d0f18c3";
const AGGREGATE_IDX = "5";
const tickerHandlers = new Map();
const searchParams = new URLSearchParams({
  api_key: API_KEY,
});
const socket = new WebSocket(`wss://streamer.cryptocompare.com/v2?${searchParams.toString()}`);
